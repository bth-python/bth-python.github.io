...
:::note
Öppna terminalen och flytta dig till din kursmapp och kör följande kommando för att skapa katalogerna som används i kmom01. Ladda också ner de senaste testerna:
...
Jobba igenom [seminarium kmom01 vecka 1](/laromaterial/seminarium/kmom011). Det görs på onsdagens lektion.
</details>
<br/>
...
1. Mer material om jämförelse och villkor. En del repetition från boken och en del nytt.
...
1.  Kolla på bilden [My code isn’t working](/img/code_not_working.jpg). Spara bilden för att underlätta när saker går fel.
...
Jobba igenom [seminarium kmom01 vecka 2](/laromaterial/seminarium/kmom012). Det görs på onsdagens lektion.
