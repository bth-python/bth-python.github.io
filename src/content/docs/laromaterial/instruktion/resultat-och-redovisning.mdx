...
När du har slutfört kursmomentet är det dags att redovisa ditt arbete. Följ stegen nedan:
...
:::note
För kmom03, kmom06 och kmom10 skall du även göra en pull request (PR) på GitHub. Läs mer om det i [Gör en (PR)](#pull-request-pr-för-kmom03-kmom06-kmom10).
:::


## Kör tester

Dubbelkolla att din kod passerar testerna och validerar med kommandot `uv run ruff check`. Om du har några fel, fixa dem före du fortsätter.

Dubbelkolla att du är klar med kursmomentet med kommandot `uv run task check-ready -- kmom<X>`, där X motsvarar det aktuella numret på kmomet (till exempel 01, 02 etc) och då kommer du få tips om hur du kan lösa felen. Du kan till exempel få fel på att det saknas en tag på din inlämning, information om det kommer nedan i [Tagga och pusha ditt repo](#tagga-och-pusha-ditt-repo).

Om inte tipsen hjälper, testar du att uppdatera din kursmiljö och pushar eventuella ändringar och kör om testerna.

```bash title="Uppdatera din kursmiljö"
...
Lägg till en tagg till ditt repo och pusha sedan både taggen och ditt repo. En tagg är ett bokmärke som pekar på en viss commit i Git. Taggen pekar ut den senaste versionen av din inlämning av ett kmom.
...
git tag -a v01.0 -m "Ready with kmom01"
```

Om du gör ändringar så taggar du din nya inlämning med ett högre versionsnummer, till exempel v01.1, om du senast använde v01.0. Du kan se vilka taggar du har med kommandot `git tag`.
...
När du pushar din tagg görs en kontroll med bland annat validering och tester lokalt innan pushen. Om något går fel, tas taggen bort och du får tips om vad du kan göra för att fixa till det. Fixa felen och kör om tester och validering, se början av denna artikel.
...
Om det inte är grönt utan rött istället som på bilden nedanför, hoppa vidare till [Actions testerna blir fel](#actions-testerna-blir-fel). Varningar behöver du inte bry dig om.

Du kan också klicka in på det jobb som blivit rött och försöka lista ut vad felet är.
