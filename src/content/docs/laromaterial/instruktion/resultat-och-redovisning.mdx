...
Dubbelkolla att du är klar med kursmomentet med kommandot `uv run task check-ready -- kmom<X>`, där X motsvarar det aktuella kmomet (till exempel 01, 02 etc) och då kommer du få tips om hur du kan lösa felen. Du kommer att få fel på att det saknas en tag på din inlämning, information om det kommer nedan i [Tagga och pusha ditt repo](#tagga-och-pusha-ditt-repo).
