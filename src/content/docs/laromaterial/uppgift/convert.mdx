...
2. `convert.py` skall innehålla kod för att omvandla ett värden, som beskrivs i texten ovanför. Tips: lägg till en utskrift, testkör programmet och gör din första commit.
