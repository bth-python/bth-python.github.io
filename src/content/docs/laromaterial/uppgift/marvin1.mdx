...
Du har jobbat allt material i "[kmom02](/kmom/kmom02)".
...
Uppgift ska lösas med grundläggande Python konstruktioner som vi gått igenom i kursen. Egenskapade funktioner får användas först i kmom03 och listor får användas först i kmom04. Konstruktioner som t.ex list/dict comprehension eller lamdauttryck godkänns inte.
