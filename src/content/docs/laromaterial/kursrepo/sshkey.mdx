...
Då fixar du det genom att ändra rättigheter på filen med din privata nyckel. Det ska endast vara du som kan läsa den. Först ställer vi oss i din hemmakatalog, sen kör vi chmod som ändrar rättigheterna och sen kolla vi med `ls` att det står `-r--r--r--` framför din privata nyckel.
