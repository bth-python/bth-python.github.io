---
title: "Fizz Buzz"
description: Lär dig skriva pseudokod till leken Fizz Buzz.
sidebar:
  order: 0211
---
...
Ex: 1, 2, Fizz, 4, Buzz, Fizz, 7, 8, Fizz, Buzz, 11, Fizz, 13, 14, FizzBuzz, 16, 17, Fizz, 19, Buzz, ..... 
...
```
I Python kan vi generera varje heltal från och med 1 till och med 100 genom:
...
2. **Att ta reda på om ett heltal är jämnt delbart med ett annat heltal**  
        ...
        Ex: 17 mod 5 blir 2 och 20 mod 5 blir 0, dvs x mod y blir 0 om y går jämnt upp i x
...
for number in range(1, 101):
    ...
    if number % 3 != 0 and number % 5 != 0:
        print(number)
```
När vi testar att köra programmet kommer vi att se att alla utskrifter kommer på ny rad. Vi har alltså en del finjustering att göra. Att få en utskrift att inte avslutas med radbrytning i Python kan vi fixa med `print(..., end = "")`, dvs 
...
Vi behöver tillföra ett komma och mellanslag, dvs strängen ", " efter varje utskrift. Eftersom alla utskrifter (oavsett om det är "Fizz", "Buzz" eller number) ska avslutas med ", "placerar vi detta efter alla selektioner, dvs för varje iteration.
...
Det finns ofta mer än en lösning på ett programmeringsproblem. För just denna uppgiften kan man t.ex undersöka delbarhet med både 3 och 5, dvs delbarhet med 15 som ett selektionsalternativ. 
