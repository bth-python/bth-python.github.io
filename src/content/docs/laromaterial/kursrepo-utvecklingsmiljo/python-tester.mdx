---
title: "python-tester" 
description: Vi tittar på testverktyget python-tester.
author: aar
revision:
...
```console title="Kör tester för convert uppgiften."
...
```
ConvertStructure 
    file convert py exist...................... FAIL

======================================================================
FAIL section: Your code produced wrong result!
======================================================================
Fails for ConvertStructure
...
Då har du koll på python-tester!
