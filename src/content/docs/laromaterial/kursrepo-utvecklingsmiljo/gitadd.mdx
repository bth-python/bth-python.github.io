...
Ditt kursrepo är ett lokalt git repo och de filer du skapar lokalt behöver du också lägga till i git repot på GitHub. Du lägger till filer via de kommandon som git erbjuder.
...
```console title="Lägg till filen README.md till repot på GitHub."
git add README.md
```
