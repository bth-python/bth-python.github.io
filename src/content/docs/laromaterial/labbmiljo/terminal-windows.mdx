...
import terminal6 from '@assets/labbmiljö/terminal/terminal6.png';
...
import terminal7 from '@assets/labbmiljö/terminal/terminal7.png';
...
När kommandot är klart kan du behöva starta om din dator.

Om du får fel när du installerar wsl, så titta i [Leta efter felkoden](#leta-efter-felkoden) för tips.

När du är klar finns wsl installerat och du kan se vilka subsystem som du har tillgängliga med följande kommando.
...
import terminal8 from '@assets/labbmiljö/terminal/terminal8.png';
...
import terminal9 from '@assets/labbmiljö/terminal/terminal9.png';
...
import terminal10 from '@assets/labbmiljö/terminal/terminal10.png';
...
import terminal11 from '@assets/labbmiljö/terminal/terminal11.png';
...
Om du får en felkod vid installationen så börjar du med att leta om det finns en vanlig lösning på ditt problem. Öppna länken "[Troubleshooting Windows Subsystem for Linux: Installation issues](https://learn.microsoft.com/en-us/windows/wsl/troubleshooting#installation-issues)" och sök efter din felkod.



### Min användare är root

Om din användare är root så har du troligen missat att skapa en ny användare, det gör man första gången som terminalen startar upp ett nytt subsystem.

För att lösa det problemet så är det enklast att ta bort ditt subsystem och installera det på nytt.

Börja med att se namnet på det subsystem du vill ta bort med `wsl --list --verbose`.
...
Lösningen är att gå in i BIOS och aktivera virtualisering. [Microsoft har en bra guide på hur man gör](https://support.microsoft.com/en-us/windows/enable-virtualization-on-windows-11-pcs-c5578302-6e43-4b4b-a449-8ced115f58e1).



### Uppgradera wsl 1 till wsl 2

Kolla vilken version du har nu.

```bash title="Kontrollera vilken version du har nu."
wsl.exe --list --verbose
```
Om det står version 2 så har du rätt version redan.

Först behöver du radera ut ditt nuvarande subsystem. Stäng ner VSCode och Ubuntu-terminalen. Starta `cmd` eller `powershell`. Exekvera:

```bash title="Ta bort ditt nuvarande subsystem."
wsl --terminate Ubuntu
wsl --unregister Ubuntu
```

Därefter kan du uppgradera wsl 1 till wsl 2 med följande kommando.

```bash title="Uppgradera wsl 1 till wsl 2."
wsl --set-default-version 2
wsl --install --distribution Ubuntu
```

När du kör sista kommandot ska du igen ange användare och lösenord. När det är klart kan du köra kommandot:

```bash title="Kontrollera att du har wsl version 2."
wsl.exe --list --verbose
```

Om det står version 2 så är du klar.
